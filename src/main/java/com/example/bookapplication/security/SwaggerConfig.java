...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("JPRIS book application",
                "An api book recommendations and reviews",
                "1.0",
                "Free to use and authenticate for protected endpoints",
                new Contact("Oakland", "www.bookapplication.com", "hicounselorjpris@gmail.com"),
                "License of API",
                "www.bookapplication.com",
